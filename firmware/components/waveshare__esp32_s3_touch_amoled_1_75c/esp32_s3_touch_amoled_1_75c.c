...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    // VENDORED CHANGE (see VENDORED.md): upstream hardcodes 40 MHz in
    // CO5300_PANEL_IO_QSPI_CONFIG and exposes no Kconfig for it. At 80 MHz the
    // banded blit of a full 466x466 frame went 32 ms -> 19 ms, measured on the
    // board, and the boot splash went from 27 of 31 frames to all 31.
