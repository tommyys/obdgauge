...
check('the splash hands over to the instruments', b.phase, 'RUNNING')
near('running reports a finished animation', b.progress, 1.0)

b.update(100.0 + SPLASH + 60.0)
...
check('a fraction short of the splash is still waking', b.phase, 'WAKING')
...
check('any channel can carry it over the line', g.boot.phase, 'RUNNING')
